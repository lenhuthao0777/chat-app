...
-- CreateIndex
CREATE INDEX "DirectMessage_memmberId_idx" ON "DirectMessage"("memmberId");
...
-- AddForeignKey
ALTER TABLE "DirectMessage" ADD CONSTRAINT "DirectMessage_memmberId_fkey" FOREIGN KEY ("memmberId") REFERENCES "Member"("id") ON DELETE CASCADE ON UPDATE CASCADE;
